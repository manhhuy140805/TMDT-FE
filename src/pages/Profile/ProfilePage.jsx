      ...
      try {
        ...
        if (initialUser) {
          const formattedInfo = {
            ...
            soDienThoai:
              initialUser.soDienThoai || initialUser.phone || "09x-xxxx-xxxx",
          ...
          const formattedAccount = {
            ...
            ngayTao: initialUser.ngayTao
              ...
              : "22/05/2026",
            capNhatLanCuoi: initialUser.capNhatLanCuoi
              ? new Date(initialUser.capNhatLanCuoi).toLocaleDateString("vi-VN")
              : "22/05/2026",
          };
        ...
        if (userId) {
          try {
            ...
            if (profileRes && profileRes.user) {
              ...
              const apiAccount = {
                ...
                ngayTao: u.ngayTao
                  ...
                  : accountForm.ngayTao,
                capNhatLanCuoi: u.capNhatLanCuoi
                  ? new Date(u.capNhatLanCuoi).toLocaleDateString("vi-VN")
                  : accountForm.capNhatLanCuoi,
              };
              setInfoForm(apiInfo);
            ...
            console.warn(
              "Backend API not reachable or endpoint failed. Using LocalStorage/Demo fallback.",
              apiErr,
            );
          }
        }
    ...
    try {
      ...
      if (userId) {
        try {
          ...
          console.warn(
            "Could not sync with database. Local changes saved.",
            apiErr,
          );
        }
      }
          ...
          <main className="profile-content-column">
                            ...
                            if (user) {
                              setInfoForm({
                                tenDangNhap:
                                  ...
                                  "nv_an_dev",
                                hoTen:
                                  user.hoTen || user.name || "Nguyen Van An",
                    ...
                    <div className="detail-row">
                      ...
                      <div className="row-value-field">
                        {isEditingInfo ? (
                          ...
                          <span className="value-text highlight-dark">
                            {infoForm.hoTen}
                          </span>
                        )}
                      </div>
            ...
            {activeTab === "caidat" && (
              <div className="profile-card tab-content-placeholder-card">
                ...
                <p>
                  Khu vực tùy chỉnh các thông số chuyên sâu về tài khoản, múi
                  giờ và cấu hình thông báo.
                </p>
                <button className="btn-placeholder-action">
                  Đi tới Cài đặt
                </button>
              </div>
            )}
            ...
            {activeTab === "baomat" && (
              <div className="profile-card tab-content-placeholder-card">
                ...
                <p>
                  Thiết lập mật khẩu mới, xác thực 2 lớp (2FA) và theo dõi các
                  phiên đăng nhập bảo vệ tài khoản.
                </p>
                <button className="btn-placeholder-action">
                  Thay đổi Mật khẩu
                </button>
            ...
            {activeTab === "thanhtoan" && (
              <div className="profile-card tab-content-placeholder-card">
                ...
                <p>
                  Quản lý tài khoản ngân hàng, ví điện tử liên kết và xem lịch
                  sử giao dịch nạp/rút tiền.
                </p>
                <button className="btn-placeholder-action">
                  Thêm Phương thức
                </button>
          ...
          <div className="profile-modal-content">
            ...
            <div className="modal-body">
              <p className="modal-desc">
                Nhập đường dẫn URL ảnh đại diện của bạn dưới đây để cập nhật tức
                thì:
              </p>
              <input
                type="text"
            ...
            <div className="modal-footer">
              ...
              <button className="btn-modal-submit" onClick={handleUpdateAvatar}>
                Cập nhật
              </button>
            </div>
          </div>
