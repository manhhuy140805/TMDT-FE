...
const ProfilePage = () => {
      ...
      if (storedUser) {
        ...
        if (isFreelancerRole(role)) {
          ...
          if (freelancerRes.success) {
            const freelancer = freelancerRes.data.data.find(
              (f) => f.userId === userId,
            );
  ...
  const reviewsTitle = isFreelancer
    ? "Đánh giá từ người thuê"
    : "Đánh giá từ freelancer";
  const reviewsDesc = isFreelancer
    ? "Dưới đây là những phản hồi từ khách hàng bạn đã từng làm việc cùng."
    : "Dưới đây là những phản hồi từ freelancer bạn đã từng hợp tác.";
  const aboutPlaceholder = isFreelancer
    ? "Chưa có mô tả kỹ năng."
    : "Chưa có mô tả.";

  return (
    <div
      className="settings-main-wrapper"
      style={{ background: "#F8FAFC", paddingBottom: "60px" }}
    >
            ...
            <div className="profile-head">
              ...
              <div className="profile-titles">
                <h1 className="profile-user-name">
                  ...
                  <i
                    className="fa-solid fa-circle-check verify-badge"
                    title="Đã xác thực"
                  ></i>
                </h1>
            ...
            <div className="profile-body">
              {activeTab === "info" && (
                <div className="section-block">
                  ...
                  <p className="section-desc">
                    Cập nhật thông tin cá nhân của bạn để xây dựng uy tín trong
                    cộng đồng.
                  </p>
              ...
              {activeTab === "reviews" && (
                <div className="section-block">
                  ...
                  <p className="section-desc">{reviewsDesc}</p>
                          ...
                          >
                            ...
                            >
                              ...
                              <div>
                                ...
                                >
                                  {review.nguoiDanhGia?.hoTen || "Người dùng"}
                                </div>
                                <div
                                  style={{ fontSize: "12px", color: "#64748B" }}
                                >
                                  {new Date(review.ngayTao).toLocaleDateString(
                                    "vi-VN",
                                  )}
                                </div>
                              </div>
                            ...
                            <div style={{ color: "#fbbf24" }}>
                              {[1, 2, 3, 4, 5].map((s) => (
                                <i
                                  key={s}
                                  className={`fa-${review.diemSo >= s ? "solid" : "regular"} fa-star`}
                                  style={{ fontSize: "14px" }}
                                ></i>
                              ))}
                            </div>
      ...
      {showReportModal && (
        ...
        >
          <div
            className="profile-power-card"
            style={{ width: "100%", maxWidth: "500px" }}
          >
            <div
              className="w-card-header"
              style={{
                padding: "20px 24px",
            ...
            <div style={{ padding: "24px" }}>
              ...
              >
                Nếu bạn nhận thấy tài khoản này có dấu hiệu lừa đảo hoặc vi phạm
                tiêu chuẩn cộng đồng, hãy cho chúng tôi biết.
              </p>
