...
const Header = () => {
  ...
  const roleLabel = user
    ? ROLE_LABELS[user.vaiTro] || user.vaiTro || "Thành viên"
    : "";
  ...
  return (
    <div
      className="global-header-sticky"
      style={{
        position: "sticky",
        top: 0,
        zIndex: 100,
    ...
    >
      ...
      <header
        ...
        style={{ position: "relative", top: "auto", zIndex: "auto" }}
      >
        <div className="header-container">
          ...
          <div
            className={`header-menu-wrapper ${mobileMenuOpen ? "mobile-open" : ""}`}
          >
